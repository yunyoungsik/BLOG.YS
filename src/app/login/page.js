...
export default function login() {
  ...
  return (
    <main id="main" className={styles.login}>
      <div className={`container ${styles.joi__iner}`}>
        ...
        <form action="/api/login" method="POST" className={styles.login__form}>
          <fieldset>
            ...
            <div className={styles.snsLogin}>
              ...
              <button type='button' className={styles.github} onClick={() => signIn("github")}>
              ...
              <button type='button' className='facebook' onClick={() => signIn("facebook")}>
